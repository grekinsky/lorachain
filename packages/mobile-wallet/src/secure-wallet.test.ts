...
describe('SecureMobileWallet', () => {
  ...
  describe('Wallet Creation', () => {
    ...
    it('should create a wallet from private key hex', () => {
      ...
      const walletFromHex = SecureMobileWallet.fromPrivateKeyHex(
        privateKeyHex,
        'secp256k1'
      );
    ...
    it('should create a wallet from seed', () => {
      ...
      expect(bytesToHex(wallet1.getPublicKey())).toBe(
        bytesToHex(wallet2.getPublicKey())
      );
    });
  ...
  describe('Wallet Export/Import', () => {
    ...
    it('should recreate wallet from exported private key', () => {
      const privateKeyHex = wallet.exportPrivateKey();
      const recreatedWallet = SecureMobileWallet.fromPrivateKeyHex(
        privateKeyHex,
        wallet.getAlgorithm()
      );
