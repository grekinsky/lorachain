...
describe('CryptographicService', () => {
  describe('Key Generation', () => {
    ...
    it('should generate deterministic keys from seed', () => {
      ...
      const keyPair1 = CryptographicService.generateKeyPairFromSeed(seed, 'secp256k1');
      const keyPair2 = CryptographicService.generateKeyPairFromSeed(seed, 'secp256k1');
    ...
    it('should generate unique keys for different seeds', () => {
      ...
      const keyPair1 = CryptographicService.generateKeyPairFromSeed(seed1, 'secp256k1');
      const keyPair2 = CryptographicService.generateKeyPairFromSeed(seed2, 'secp256k1');
  ...
  describe('Address Generation', () => {
    it('should generate valid addresses from public keys', () => {
      const keyPair = CryptographicService.generateKeyPair('secp256k1');
      const address = CryptographicService.generateAddress(keyPair.publicKey, 'secp256k1');
    ...
    it('should generate different addresses for different algorithms', () => {
      ...
      const keyPairSecp = CryptographicService.generateKeyPairFromSeed(privateKey, 'secp256k1');
      const keyPairEd = CryptographicService.generateKeyPairFromSeed(privateKey, 'ed25519');
      
      const addressSecp = CryptographicService.generateAddress(keyPairSecp.publicKey, 'secp256k1');
      const addressEd = CryptographicService.generateAddress(keyPairEd.publicKey, 'ed25519');
  ...
  describe('Signature Operations', () => {
    it('should create valid signatures', async () => {
      ...
      const signature =  CryptographicService.sign(message, keyPair.privateKey, 'secp256k1');
    ...
    it('should verify valid signatures', async () => {
      ...
      const signature =  CryptographicService.sign(message, keyPair.privateKey, 'secp256k1');
      const isValid =  CryptographicService.verify(signature, message, keyPair.publicKey);
    ...
    it('should reject invalid signatures', async () => {
      ...
      const signature =  CryptographicService.sign(message, keyPair.privateKey, 'secp256k1');
      const isValid =  CryptographicService.verify(signature, wrongMessage, keyPair.publicKey);
    ...
    it('should reject signatures with wrong public key', async () => {
      ...
      const signature =  CryptographicService.sign(message, keyPair1.privateKey, 'secp256k1');
      const isValid =  CryptographicService.verify(signature, message, keyPair2.publicKey);
    ...
    it('should handle signature malleability', async () => {
      ...
      const isValid =  CryptographicService.verify(malleableSignature, message, keyPair.publicKey);
      expect(isValid).toBe(false);
    });
    ...
    it('should work with ed25519 signatures', async () => {
      ...
      const signature =  CryptographicService.sign(message, keyPair.privateKey, 'ed25519');
      const isValid =  CryptographicService.verify(signature, message, keyPair.publicKey);
...
describe('SecureTransactionManager', () => {
  it('should create transactions with valid signatures', async () => {
    const keyPair = CryptographicService.generateKeyPair('secp256k1');
    const from = CryptographicService.generateAddress(keyPair.publicKey, 'secp256k1');
  ...
  it('should reject transactions with invalid signatures', async () => {
    const keyPair1 = CryptographicService.generateKeyPair('secp256k1');
    const keyPair2 = CryptographicService.generateKeyPair('secp256k1');
    const from = CryptographicService.generateAddress(keyPair1.publicKey, 'secp256k1');
    const to = CryptographicService.generateAddress(keyPair2.publicKey, 'secp256k1');
...
describe('Security Validation', () => {
  ...
  it('should resist signature forgery attempts', async () => {
    ...
    const validSignature =  CryptographicService.sign(message, keyPair.privateKey, 'secp256k1');
    ...
    const isValidReal =  CryptographicService.verify(validSignature, message, keyPair.publicKey);
    const isValidFake =  CryptographicService.verify(fakeSignature, message, keyPair.publicKey);
  ...
  it('should validate signature algorithms', async () => {
    ...
    const signatureSecp =  CryptographicService.sign(message, keyPairSecp.privateKey, 'secp256k1');
    const signatureEd =  CryptographicService.sign(message, keyPairEd.privateKey, 'ed25519');
  ...
  it('should handle edge cases securely', () => {
    ...
    const hashedMinimalMessage = CryptographicService.hashMessage(minimalMessage);
    
    const signature = CryptographicService.sign(hashedMinimalMessage, keyPair.privateKey, 'secp256k1');
    const isValid = CryptographicService.verify(signature, hashedMinimalMessage, keyPair.publicKey);
    ...
    const largeSig = CryptographicService.sign(hashedLargeMessage, keyPair.privateKey, 'secp256k1');
    const isLargeValid = CryptographicService.verify(largeSig, hashedLargeMessage, keyPair.publicKey);
