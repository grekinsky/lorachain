...
describe('UTXOManager', () => {
  ...
  describe('Address Queries', () => {
    ...
    it('should get UTXOs for address', () => {
      const utxos = utxoManager.getUTXOsForAddress(
    ...
    it('should calculate balance for address', () => {
      const balance1 = utxoManager.calculateBalance(
        '1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa'
      );
      const balance2 = utxoManager.calculateBalance(
    ...
    it('should get spendable UTXOs for amount', () => {
      const spendableUTXOs = utxoManager.getSpendableUTXOs(
        '1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa',
        75
      );
  ...
  describe('Validation', () => {
    ...
    it('should validate UTXO ownership', () => {
      ...
      const mockPublicKey =
        '0404040404040404040404040404040404040404040404040404040404040404040404040404040404040404040404040404040404040404040404040404040404';
